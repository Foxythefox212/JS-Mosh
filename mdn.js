...
const secretNumber = Math.trunc(Math.random() * 20) + 1;//Face nr aleatorii de la 1 la 20
document.querySelector('.number').textContent = secretNumber;//Apare nr-ul secret
